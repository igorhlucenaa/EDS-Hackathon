import { User, UserBet, Transaction, Promotion, Notification } from '../models/types';
...
export const mockBets: UserBet[] = [
    ...
    selections: [
      {
        ...
        outcomeId: 'o-under-1', outcomeName: 'Menos de 2.5', odds: 1.90,
      },
      {
  ...
  },
  {
    ...
    selections: [{
      ...
      outcomeId: 'o-h-3', outcomeName: 'Corinthians', odds: 2.10,
    }],
    stake: 75, potentialReturn: 157.50, status: 'won',
...
export const mockTransactions: Transaction[] = [
  ...
  { id: 'tx-3', type: 'win', amount: 157.50, status: 'completed', createdAt: new Date(Date.now() - 22 * 3600000).toISOString(), description: 'Aposta #bet-3' },
