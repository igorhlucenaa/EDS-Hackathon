import { SportEvent, Market } from '../models/types';
...
export const mockLiveEvents: SportEvent[] = [
  {
    ...
    markets: [mainMarket(1.45, 4.50, 6.00), overUnderMarket(2.5, 1.55, 2.40), bttsMarket(1.35, 3.10)],
    isFeatured: true,
    viewerCount: 45230,
  },
  {
    ...
    markets: [mainMarket(2.80, 3.20, 2.50), overUnderMarket(2.5, 1.90, 1.90), bttsMarket(1.75, 2.05)],
    isFeatured: true,
    viewerCount: 128400,
  },
  {
    ...
    markets: [mainMarket(1.30, 5.50, 8.00), overUnderMarket(4.5, 1.70, 2.10), bttsMarket(1.12, 6.00)],
    isFeatured: true,
    viewerCount: 312000,
  },
  {
    ...
    markets: [{
      ...
      outcomes: [
        { id: 'o-lal', name: 'LA Lakers', odds: 2.10, isLocked: false },
...
export const mockUpcomingEvents: SportEvent[] = [
  {
    ...
    markets: [mainMarket(2.30, 3.10, 3.20), overUnderMarket(2.5, 2.00, 1.80), bttsMarket(1.85, 1.95)],
    isFeatured: true,
  },
  {
    id: 'ev-up-2',
    ...
    markets: [mainMarket(1.90, 3.50, 3.80), overUnderMarket(2.5, 1.65, 2.20), bttsMarket(1.60, 2.30)],
    isFeatured: true,
  },
  {
    id: 'ev-up-3',
    ...
    markets: [mainMarket(2.50, 3.00, 2.90), overUnderMarket(2.5, 1.85, 1.95), bttsMarket(1.72, 2.10)],
    isFeatured: true,
  },
  {
    id: 'ev-up-4',
    ...
    markets: [mainMarket(2.40, 3.20, 2.95), overUnderMarket(2.5, 1.95, 1.85), bttsMarket(1.80, 2.00)],
    isFeatured: false,
  },
  {
    id: 'ev-up-5',
