...
import { BetSelection, BetslipMode, BetType } from '../data/models/types';
...
export const useBetslipStore = create<BetslipStore>()(
  persist(
    ...
    { name: 'eds-betslip', partialize: (s) => ({ selections: s.selections, stake: s.stake, mode: s.mode, betType: s.betType }) }
  )
);
